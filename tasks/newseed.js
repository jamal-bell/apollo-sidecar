...
const numUsers = 50;
const numLessons = 200;
const numberOfQaEntries = 75; // Adjust as needed
//============================================================================================================

const firstNameList = ['Alice', 'Johnson', 'Bob', 'Charlie', 'David', 'Sam', 'Tom', 'Mario', 'Luigi', 'Princess', 'Bowser', 'King', 'Yoshi', 'Dino', 'Wario', 'Greedy', 'Toad', 'Mushroom', 'Koopa', 'Troopa', 'Kong'];
const lastNameList = ['Alice', 'Johnson', 'Bob', 'Charlie', 'David', 'Sam', 'Tom', 'Mario', 'Luigi', 'Princess', 'Bowser', 'King', 'Yoshi', 'Dino', 'Wario', 'Greedy', 'Toad', 'Mushroom', 'Koopa', 'Troopa', 'Kong'];
const userRoleList = ['user', 'admin'];
const LessonTitlePrefixList = ["Get Started With", "Intro to", "Advanced", "Web Develepment Using", "Beginner"]
const subjects = ["JavaScript", "NodeJS", "React", "HTML", "Express & Express Handlebars", "MongoDB", "TypeScript", "REST API"]
const qaTitleList = ["What is the best way to learn", "Can I import modules in", "Can I make an an API in","What's needed to make an app in", "Can someone help with errors in"]
...
//         const emailAddress = `${firstName.toLowerCase()}.${lastName.toLowerCase()}@example.com`;
//         const passWord = 'Secure789!';
//         const userRole = userRoleList[Math.floor(Math.random() * userRoleList.length)];
//         const handle = lastName;
      
//         await userData.registerUser(firstName, lastName, emailAddress, passWord, userRole, handle);
//     }
try {
    userCollection = await users();
  } catch (e) {
  ...
  try {
    ...
    console.error('Seeding failed at users:', e);
...
try {
  for (let i = 0; i < numberOfQaEntries; i++) {
    ...
    const randomLessonObject = allLessonIdsForQaSeeding[Math.floor(Math.random() * allLessonIdsForQaSeeding.length)];
    const qaTitlePrefix = qaTitleList[Math.floor(Math.random() * qaTitleList.length)];
